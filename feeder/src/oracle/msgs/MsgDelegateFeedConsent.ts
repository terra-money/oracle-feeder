...
> {
  ...
  public static fromAmino(data: MsgDelegateFeedConsent.Amino): MsgDelegateFeedConsent {
    const {
  ...
  public static fromData(data: MsgDelegateFeedConsent.Data): MsgDelegateFeedConsent {
  ...
  public static fromProto(proto: MsgDelegateFeedConsent.Proto): MsgDelegateFeedConsent {
  ...
  public static unpackAny(msgAny: Any): MsgDelegateFeedConsent {
    return MsgDelegateFeedConsent.fromProto(MsgDelegateFeedConsent_pb.decode(msgAny.value))
  }
}
