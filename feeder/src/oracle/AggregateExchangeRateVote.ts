...
> {
   ...
   */
  constructor(public exchange_rate_tuples: ExchangeRateTuple[], public voter: ValAddress) {
    super()
  }

  public static fromAmino(data: AggregateExchangeRateVote.Amino): AggregateExchangeRateVote {
  ...
  public static fromData(data: AggregateExchangeRateVote.Data): AggregateExchangeRateVote {
    const { exchange_rate_tuples, voter } = data
    return new AggregateExchangeRateVote(
  ...
  public static fromProto(data: AggregateExchangeRateVote.Proto): AggregateExchangeRateVote {
    return new AggregateExchangeRateVote(
