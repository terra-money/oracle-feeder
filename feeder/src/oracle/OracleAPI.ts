...
export class OracleAPI extends BaseAPI {
  ...
  public async exchangeRates(params: APIParams = {}): Promise<Coins> {
    return this.c
      .get<{ exchange_rates: Coins.Data }>(
        `/terra/oracle/denoms/exchange_rates`,
        params
      )
  ...
  public async exchangeRate(
    ...
    return this.c
      .get<{ exchange_rate: string }>(
        `/terra/oracle/denoms/${denom}/exchange_rate`,
        params
      )
      .then(d =>
        Coin.fromData({
  ...
  public async activeDenoms(params: APIParams = {}): Promise<Denom[]> {
    ...
    return this.c
      .get<{ actives: Denom[] }>(`/terra/oracle/denoms/actives`, params)
      .then(d => d.actives);
  }
  ...
  public async feederAddress(
    ...
    return this.c
      .get<{ feeder_addr: AccAddress }>(
        `/terra/oracle/validators/${validator}/feeder`,
        params
      )
  ...
  public async misses(
    ...
    return this.c
      .get<{ miss_counter: string }>(
        `/terra/oracle/validators/${validator}/miss`,
        params
      )
