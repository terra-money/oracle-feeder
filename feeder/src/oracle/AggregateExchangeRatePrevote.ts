import { ValAddress } from '@terra-money/station.js'
...
> {
   ...
   */
  constructor(public hash: string, public voter: ValAddress, public submit_block: number) {
    super()
  }

  public static fromAmino(data: AggregateExchangeRatePrevote.Amino): AggregateExchangeRatePrevote {
  ...
  public static fromData(data: AggregateExchangeRatePrevote.Data): AggregateExchangeRatePrevote {
    const { hash, voter, submit_block } = data
    return new AggregateExchangeRatePrevote(hash, voter, Number.parseInt(submit_block))
  }
  ...
  public static fromProto(data: AggregateExchangeRatePrevote.Proto): AggregateExchangeRatePrevote {
